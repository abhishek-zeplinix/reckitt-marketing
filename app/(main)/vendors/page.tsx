...
const ManageVendorsPage = () => {
    ...
    const handleEditSupplier = (sup: any) => {
        ...
        router.push(`/vendors/vendor?edit=true&supId=${supId}`);
    };
        ...
        return (
            <div className="flex justify-content-between ">
                ...
                <div className="flex justify-content-end">
                    <Button icon="pi pi-plus" size="small" label="Import Vendors" aria-label="Add Vendors" className="default-button " style={{ marginLeft: 10 }} onClick={() => setVisible(true)} />
                    <Dialog
                        header={dialogHeader}
                        visible={visible}
                        style={{ width: '50vw' }}
